                ...
                href && (
                  ...
                  >
                    <a
                      ...
                      className="flex items-center justify-center rounded-sm bg-transparent p-0.5 text-primary-900 hover:icon-bg-blue hover:text-slate-200 hover:dark:bg-slate-800 hover:dark:text-slate-200"
                    >
