...
export const heroServices: HeroProps = {
  ...
  callToAction: {
    ...
    href: 'https://github.com/asfandyar-malik/chatsite-landing',
    targetBlank: true,
  },
  image: {
    src: heroImg,
  ...
  testimonials: [
    {
      name: 'Silver Jordan',
      job: 'Senior Marketer',
      testimonial: `I had never found it so easy to customize a website. StreetInterview's templates are incredibly flexible, and with Tailwind CSS, I've managed to give my website the look and feel I always wanted. Highly recommended!`,
      image: {
    ...
    },
    {
      name: 'Lisa Gordon',
      job: 'Project Manager',
      testimonial: `Their templates are not only stunning but also user-friendly. The support I received from their community has been exceptional. I'm proud to say that I've built my dream website with StreetInterview.`,
      image: {
